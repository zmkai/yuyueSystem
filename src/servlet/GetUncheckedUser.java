...
/**
 * Servlet implementation class GetUncheckedUser
 */
@WebServlet("/getUncheckedUser")
public class GetUncheckedUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String result = "";
		String sql = "SELECT account,username,email,identity,photo_path from user_table WHERE mark = '0'";
